        ...
        <div className="col s12 m8 offset-m2">
          <div className=" card-panel hoverable ">
            ...
            <p className="about">
              ...
              originally from Nigeria West Africa, moved to Germany late 2016
              for my master studies. After graduating as a Marine Geoscientist
              from the University of Bremen in September 2020, I decided to work
              on developing my IT skills in every way possible and every
              descission has brought me to this moment. My Tech skills includes
              but not limited to HTML, CSS, Javascript, React, Node JS, Express
              and SQL/NOSQL. I am also very enthusiastic about cloud computing
              as this plays a huge role in modern day technology.
            </p>
            <p>
